...
class Blog extends Component {
  ...
  componentDidMount() {
    getData(
      `${process.env.REACT_APP_ABOUT_BASE_REGION_URL}content_types/${process.env.REACT_APP_BLOG_CONTENT_TYPE}/entries?environment=${process.env.REACT_APP_PUBLISH_ENVIRONMENT}&locale=en-us`
    )
      .then(data => {
        this.setState({
          blogPage: data
